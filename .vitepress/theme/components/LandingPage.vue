  ...
  <div class="xl:grid xl:grid-cols-[3fr_4fr] gap-4" min-h-80vh px8 xl:px20 py5 max-w-100vw xl:max-w-450 mxa>
    <div flex="~ col items-center justify-center" min-h-150>
      ...
      <div flex="~ gap-3 justify-center" p4 mt-5>
        <a href="/guide/" class="bg-$vp-c-brand-3 text-white! no-underline! px5 py3 text-xl font-bold rounded-xl hover:bg-$vp-c-brand-1">Начать знакомство</a>
        <a href="/guide/why" class="bg-$vp-c-gray-1 text-white! no-underline! px5 py3 text-xl font-bold rounded-2xl hover:bg-$vp-c-brand-1">Зачем</a>
      </div>
    </div>
    <div flex>
      <div w-180 ma>
